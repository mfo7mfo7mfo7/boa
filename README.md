...
- [Boa 3.2.2](docs/release-notes-3.2.2.md)
...
- [Boa 2.5](docs/release-notes-2.5.md)
...
```bash
docker run --rm -p 8000:8000 -v boa-data:/data ghcr.io/chengenzo/boa:3.2.2
```
